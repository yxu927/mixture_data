...
The analysis scripts are published separately as `analysis_scripts.zip` on the
linked Zenodo deposit (see Contents and Licensing). The directory structure
inside the simulation archives is described under Layout.

## Contents and Licensing

The files in this Dryad archive — the empirical alignments and BEAST XML in
`real/`, and the simulation inputs, MCMC outputs, and posterior summaries in
`simulation/` — are released under CC0.

The Python post-processing/figure scripts and the RelaxClockAveraging software
are licensed under MIT and archived on Zenodo:

- RelaxClockAveraging software (version 1.2): Zenodo DOI 10.5281/zenodo.20684860
  (concept DOI for all versions: 10.5281/zenodo.19725719;
  source: https://github.com/yxu927/RelaxClockAveraging)
- Analysis scripts: on the Zenodo deposit linked to this dataset.
...
5. Use the analysis scripts from the linked Zenodo deposit on extracted
   simulation folders to regenerate tree-statistic annotations and
   coverage/model-recovery figures.
...
The RelaxClockAveraging software release used here is version 1.2, archived at
Zenodo DOI 10.5281/zenodo.20684860 (concept DOI for all versions:
10.5281/zenodo.19725719), and developed at
<https://github.com/yxu927/RelaxClockAveraging>. The current GitHub release
...
data sources listed under Dataset Provenance. The data archive DOI is
`10.5061/dryad.9w0vt4bwv` and the software DOI is `10.5281/zenodo.20684860`
(RelaxClockAveraging version 1.2).
